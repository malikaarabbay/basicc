...
class Article extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['anounce_ru', 'description_ru', 'anounce_kz', 'description_kz', 'meta_keywords', 'meta_description'], 'string'],
            ...
            [['title_ru', 'description_ru', 'title_kz', 'description_kz'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'title_kz' => Yii::t('app', 'Title RU'),
            'file' => Yii::t('app', 'File'),
            'category_id' => Yii::t('app', 'Category'),
            'anounce_ru' => Yii::t('app', 'Anounce RU'),
            'anounce_kz' => Yii::t('app', 'Anounce KZ'),
