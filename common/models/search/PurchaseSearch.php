...
class PurchaseSearch extends Purchase
{
    ...
    public function rules()
    {
        return [
            ...
            [['title_ru', 'description_ru', 'title_kz', 'description_kz', 'photo', 'purchase_file', 'slug', 'meta_title', 'meta_keywords', 'meta_description'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'title_ru', $this->title_ru])
            ...
            ->andFilterWhere(['like', 'purchase_file', $this->purchase_file])
